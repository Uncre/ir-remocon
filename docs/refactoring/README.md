...
Phase 7 の個別計画書はまだありません。Phase 7 に着手する場合は、既存文書と現行コードを
照合して計画を作り、ユーザーと合意してから実装します。Phase の区切りでは必ず停止します。
...
| `HANDOFF.md` | Phase 1〜6 の実装履歴、検証結果、未解決事項、実機手順 | Phase 完了時と新事実判明時に更新 |
